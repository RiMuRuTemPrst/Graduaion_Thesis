...
\begin{itemize}
    \item A post-training mixed-precision quantization of the HiFiC model, with FP32 input/output interfaces and FP16 internal computation, that preserves compression quality: PSNR and SSIM remain almost unchanged compared with the FP32 baseline.
    ...
    \item A complete implementation on the ZCU104 platform operating at 300~MHz (maximum 308.74~MHz) that reconstructs one $256\times256$ image in 735.6~ms at a throughput of 122.8~GOPS, about $1459\times$ faster than the CPU software baseline.
\end{itemize}
